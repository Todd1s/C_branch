...
START_TEST(equal_test_1) {
  int rowsuite = 2, colsuite = 3;
  matrix_t A = {0}, B = {0};
  s21_create_matrix(rowsuite, colsuite, &A);
  s21_create_matrix(rowsuite, colsuite, &B);
  A.matrix[0][0] = -565.0;
  A.matrix[0][1] = 336.0;
  A.matrix[0][2] = 387.0;
  A.matrix[1][0] = -571.0;
...
START_TEST(s21_eq_matrix_6) {
  int rowsuite = 1, columnsuite = 2;
  int rows2 = 2, columns2 = 1;
  matrix_t A = {0}, B = {0};
  s21_create_matrix(rowsuite, columnsuite, &A);
...
int main(void) {
  Suite *suite = suite_create("\033[42mExt tests\033[0m");
  ...
  tcase_add_test(tc_core, equal_test_1);
  tcase_add_test(tc_core, equal_test_2);
  tcase_add_test(tc_core, equal_test_3);
  tcase_add_test(tc_core, equal_test_4);
  tcase_add_test(tc_core, equal_test_5);
  ...
  tcase_add_test(tc_core, transpose_test_0);
  tcase_add_test(tc_core, transpose_test_1);
  tcase_add_test(tc_core, transpose_test_2);
  tcase_add_test(tc_core, transpose_test_3);
  tcase_add_test(tc_core, transpose_test_4);
  tcase_add_test(tc_core, transpose_test_5);
  tcase_add_test(tc_core, transpose_test_null_ptr1);
  tcase_add_test(tc_core, transpose_test_null_ptr2);
  ...
  tcase_add_test(tc_core, s21_mul_matrix_1_err);
  tcase_add_test(tc_core, s21_mul_matrix_2_err);
  tcase_add_test(tc_core, s21_mul_matrix_3_err);
  tcase_add_test(tc_core, num_mul_test_0);
  tcase_add_test(tc_core, num_mul_test_1);
  tcase_add_test(tc_core, num_mul_test_2);
  tcase_add_test(tc_core, num_mul_test_3);
  tcase_add_test(tc_core, num_mul_test_4);
  tcase_add_test(tc_core, num_mul_test_5);
  tcase_add_test(tc_core, s21_mul_num_1_err);
  tcase_add_test(tc_core, sum_test_1);
  tcase_add_test(tc_core, sum_test_2);
  tcase_add_test(tc_core, sum_test_3);
  tcase_add_test(tc_core, sum_test_4);
  tcase_add_test(tc_core, sum_test_5);
  tcase_add_test(tc_core, sum_test_6);
  tcase_add_test(tc_core, s21_sum_matrix_1_err);
  tcase_add_test(tc_core, s21_sum_matrix_2_err);
  tcase_add_test(tc_core, s21_sum_matrix_3_err);
  ...
  tcase_add_test(tc_core, s21_sub_matrix_1_err);
  tcase_add_test(tc_core, s21_sub_matrix_2_err);
  tcase_add_test(tc_core, s21_sub_matrix_3_err);
  tcase_add_test(tc_core, calc_complements_test_0);
  ...
  tcase_add_test(tc_core, calc_complements_test_5);
  tcase_add_test(tc_core, calc_complements_test_null_ptr1);
  tcase_add_test(tc_core, calc_complements_test_null_ptr2);
  tcase_add_test(tc_core, s21_alc_complements_3_err);
  tcase_add_test(tc_core, det_test_0);
  tcase_add_test(tc_core, det_test_1);
  tcase_add_test(tc_core, det_test_2);
  tcase_add_test(tc_core, det_test_3);
  tcase_add_test(tc_core, det_test_4);
  tcase_add_test(tc_core, det_test_5);
  tcase_add_test(tc_core, det_test_null_ptr1);
  tcase_add_test(tc_core, s21_determinant_3_err);
  tcase_add_test(tc_core, inverse_matrix_test_0);
  ...
  tcase_add_test(tc_core, inverse_matrix_test_5);
  tcase_add_test(tc_core, inverse_matrix_test_null_ptr1);
  tcase_add_test(tc_core, inverse_matrix_test_null_ptr2);
  tcase_add_test(tc_core, s21_inverse_matrix_3_err);
  tcase_add_test(tc_core, s21_inverse_matrix_4_err);
