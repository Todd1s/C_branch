...
// START_TEST(s21_not_comprare_test_2) {
//   matrix_t A = {NULL, 3, 3};
//   s21_create_matrix(A.rows, A.columns, &A);
//   double values[9] = {9, 8, 7, 6, 5, 4, 3, 2, 1};
//   s21_custom_fill_matrix(&A, values);
...
//   matrix_t A = {NULL, 3, 3};
//   s21_create_matrix(A.rows, A.columns, &A);
//   double values[9] = {9, 2.12345677, 7, 6, 5, 4, 3, 2, 1};
//   s21_custom_fill_matrix(&A, values);
//   matrix_t B = {NULL, 3, 3};
//   s21_create_matrix(B.rows, B.columns, &B);
//   double values1[9] = {1, 2.12345677, 3, 4, 5, 6, 7, 8, 9};
//   s21_custom_fill_matrix(&B, values1);
//   matrix_t C = {NULL, 3, 3};
//   s21_create_matrix(C.rows, C.columns, &C);
//   int res = s21_sum_matrix(&A, &B, &C);
...
int main(void) {
  Suite *suite = suite_create("\033[42mSum\033[0m");
  ...
  // tcase_add_test(tc_core, s21_not_comprare_test_2);
