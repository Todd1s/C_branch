...
int main(void) {
  ...
  // s21_is_equal
  tcase_add_test(tc_core, s21_is_equal_pos_pos);
  tcase_add_test(tc_core, s21_is_equal_neg_neg);
  tcase_add_test(tc_core, s21_is_equal_er_pos_neg);
  tcase_add_test(tc_core, s21_is_equal_er);
  // s21_is_not_equal
  tcase_add_test(tc_core, s21_is_not_equal_pos_pos_er);
  tcase_add_test(tc_core, s21_is_not_equal_neg_neg_er);
  tcase_add_test(tc_core, s21_is_not_equal_pos_neg);
  tcase_add_test(tc_core, s21_is_not_equal_pos_pos);
  // s21_is_less
  tcase_add_test(tc_core, s21_is_less_equal);
  tcase_add_test(tc_core, s21_is_less_pos_neg);
  tcase_add_test(tc_core, s21_is_less_neg_pos);
  tcase_add_test(tc_core, s21_is_less_pos_pos);
  tcase_add_test(tc_core, s21_is_less_pos_pos_er);
  tcase_add_test(tc_core, s21_is_less_neg_neg);
  tcase_add_test(tc_core, s21_is_less_neg_neg_er);
  // s21_is_less_or_equal
  tcase_add_test(tc_core, s21_is_less_or_equal_eq);
  tcase_add_test(tc_core, s21_is_less_or_equal_pos_neg);
  tcase_add_test(tc_core, s21_is_less_or_equal_neg_pos);
  tcase_add_test(tc_core, s21_is_less_or_equal_pos_pos);
  tcase_add_test(tc_core, s21_is_less_or_equal_pos_pos_er);
  tcase_add_test(tc_core, s21_is_less_or_equal_neg_neg);
  tcase_add_test(tc_core, s21_is_less_or_equal_neg_neg_er);
  // s21_is_greater
  tcase_add_test(tc_core, s21_is_greater_eq);
  tcase_add_test(tc_core, s21_is_greater_pos_neg);
  tcase_add_test(tc_core, s21_is_greater_neg_pos);
  tcase_add_test(tc_core, s21_is_greater_pos_pos);
  tcase_add_test(tc_core, s21_is_greater_pos_pos_er);
  tcase_add_test(tc_core, s21_is_greater_neg_neg);
  tcase_add_test(tc_core, s21_is_greater_neg_neg_er);
  // s21_is_greater_or_equal
  tcase_add_test(tc_core, s21_is_greater_or_equal_eq);
  tcase_add_test(tc_core, s21_is_greater_or_equal_pos_neg);
  tcase_add_test(tc_core, s21_is_greater_or_equal_neg_pos);
  tcase_add_test(tc_core, s21_is_greater_or_equal_pos_pos);
  tcase_add_test(tc_core, s21_is_greater_or_equal_pos_pos_er);
  tcase_add_test(tc_core, s21_is_greater_or_equal_neg_neg);
  tcase_add_test(tc_core, s21_is_greater_or_equal_neg_neg_er);
