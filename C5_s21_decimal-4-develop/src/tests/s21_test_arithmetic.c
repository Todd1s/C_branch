...
void set_sign(s21_decimal *src, int sign) { src->bits[3] |= sign ? MINUS : 0; }
...
int main(void) {
  ...
  tcase_add_test(tc_core, s21_sub_pos_pos);
  tcase_add_test(tc_core, s21_sub_pos_pos2);
  tcase_add_test(tc_core, s21_sub_pos_posE);
  tcase_add_test(tc_core, s21_sub_posE_posE);
  tcase_add_test(tc_core, s21_sub_neg_neg);
  tcase_add_test(tc_core, s21_sub_neg_negE);
  tcase_add_test(tc_core, s21_sub_negE_negE);
  tcase_add_test(tc_core, s21_sub_pos_neg);
  tcase_add_test(tc_core, s21_sub_neg_pos);
  tcase_add_test(tc_core, s21_sub_0_0);
  tcase_add_test(tc_core, s21_sub_pos29_pos);
  tcase_add_test(tc_core, s21_add_pos_pos);
  tcase_add_test(tc_core, s21_add_pos_posE);
  tcase_add_test(tc_core, s21_add_posE_posE);
  tcase_add_test(tc_core, s21_add_neg_neg);
  tcase_add_test(tc_core, s21_add_neg_negE);
  tcase_add_test(tc_core, s21_add_negE_negE);
  tcase_add_test(tc_core, s21_add_pos_neg);
  tcase_add_test(tc_core, s21_add_neg_pos);
  tcase_add_test(tc_core, s21_add_0_0);
