...
START_TEST(s21_running_test) {
  ...
  double values[9] = {9, 8, 7, 6, 6, 4, 3, 2, 1};
...
int main(void) {
  Suite *suite = suite_create("\033[42mInverse\033[0m");
  ...
  tcase_add_test(tc_core, s21_det_zero_test);
